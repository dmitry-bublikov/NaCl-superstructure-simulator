...
const int COMP_C = 4;         // number of cation components (including vacancy)
...
{
    int st_c1, st_c2, st_c3, st_c4;     // stoichiometry for each cation
    uint8_t ch_c1, ch_c2, ch_c3, ch_c4; // cation charges
...
// **************************************************************************************************
      ...
      for (st_c1 = 1; st_c1 <= diff_c; st_c1++)
    {
        ...
        {
            st_c4 = cf - st_c1 - st_c2 - st_c3;
            if (st_c4 < 1 || st_c4 > st_c3) continue;
            ...
            for (int c = 0; c < charge_count_c; c++)
            {
                ...
                int charges_c[] = {ch_c1, ch_c2, ch_c3, ch_c4};
                ...
                // total charge for cations
                 int sum_c = st_c1*ch_c1 + st_c2*ch_c2 + st_c3*ch_c3 + st_c4*ch_c4;
