...
const int COMP_C = 6;         // number of cation components (including vacancy)
...
{
    int st_c1, st_c2, st_c3, st_c4, st_c5, st_c6;     // stoichiometry for each cation
    uint8_t ch_c1, ch_c2, ch_c3, ch_c4, ch_c5, ch_c6; // cation charges
...
// **************************************************************************************************
      ...
      for (st_c1 = 1; st_c1 <= diff_c; st_c1++)
    {
        ...
        {
            st_c6 = cf - st_c1 - st_c2 - st_c3 - st_c4 - st_c5;
            if (st_c6 < 1 || st_c6 > st_c5) continue;
            ...
            for (int c = 0; c < charge_count_c; c++)
            {
                ...
                int charges_c[] = {ch_c1, ch_c2, ch_c3, ch_c4, ch_c5, ch_c6};
                ...
                // total charge for cations
                 int sum_c = st_c1*ch_c1 + st_c2*ch_c2 + st_c3*ch_c3 + st_c4*ch_c4 + st_c5*ch_c5 + st_c6*ch_c6;
