...
charge_to_count_c[ch_c7] = st_c7;
    ...
    // Step 2: Collect all present charges (1..7) and sort them
    vector<pair<int, int>> present_charges_c; // (charge, count)
    ...
    // Step 3: Output with fixed symbols A, B, C, D, E, F
    char fixed_symbols_c[] = {'A', 'B', 'C', 'D', 'E', 'F', 'F'};
    ...
    // Step 4: Output vacancy (charge 0) at the end
