...
const int COMP_A = 3;         // number of anion components (including vacancy)
...
int main(int argc, char **argv)
{
    ...
    int st_a1, st_a2, st_a3;      // stoichiometry for each anion
    uint8_t ch_a1, ch_a2, ch_a3;  // anion charges
...
// **************************************************************************************************
    ...
    int diff_c=cf - (COMP_C - 1), diff_a=cf - (COMP_A - 1), max_ch_c=(cf-2)*3+2+1;
    ...
    for (st_a1 = 1; st_a1 <= diff_a; st_a1++)
    {
        ...
        {
            st_a3 = cf - st_a1 - st_a2;
            if (st_a3 < 1 || st_a3 > st_a2) continue;
            ...
            for (int c = 0; c < charge_count_a; c++)
            {
                ...
                int charges_a[] = {ch_a1, ch_a2, ch_a3};
                ...
                int sum_a = st_a1*ch_a1 + st_a2*ch_a2 + st_a3*ch_a3;
