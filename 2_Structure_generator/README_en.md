...
Input
Stoichiometry files: stoichiometry_N.txt (where N is the file number)

Input parameters:

Stoichiometry file number

Anion charge (0, 1, 2, 3)

Allowed deviation from local balance

Output
File: local_balance_N_B_D.txt

N - stoichiometry file number
...
Algorithm
Read input file with stoichiometries
...
Write found stoichiometries to output file
...
Check local balance for 16 octahedra
